...
const Header = () => {
  return (
    ...
    <header className='px-6 lg:px-14 h-full w-full mx-auto'>
      <div className={`${styles['header-bg']} mt-6 bg-gray-500 text-white pt-8 pb-16 rounded-2xl text-center lg:h-[65%]`}>
        <h1 className='text-[1.75rem] leading-9 px-6 font-bold lg:mt-36 lg:leading-[4rem] lg:text-5xl lg:px-36'>Discover the Worlds Wonders with Wander World</h1>
